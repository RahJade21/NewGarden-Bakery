...
export const cardItems = [
  { imgUrl: bread1, name: "Whole Grain Spelt", cost: "6.00", weight: "390g", info: info, description: "Freshly baked bread with organic ingredients." },
  { imgUrl: bread2, name: "Sourdough Rye", cost: "7.50", weight: "420g", info: info, description: "Freshly baked bread with organic ingredients." },
  { imgUrl: bread3, name: "Multigrain Loaf", cost: "6.80", weight: "400g", info: info, description: "Freshly baked bread with organic ingredients." },
...
export const aboutUs = [
  { 
    title: "Custom Cakes",
    description: "Design your dream cake with Charlotte Bakery’s Custom Cakes. Choose flavours, fillings, and designs made to order with premium ingredients. Perfect for birthdays, weddings, and special celebrations, each cake is crafted with care and beautifully presented for unforgettable moments."
  },
  {
    title: "Letter Cakes",
    description: "Stylish letter-shaped cakes personalized with your choice of initials or special words. Decorated with fresh fruits, macarons, or delicate flowers - a charming way to surprise your loved ones on meaningful occasions."
  },
  {
    title: "Classic Cakes",
